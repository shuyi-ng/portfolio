    ...
    <main>
      ...
      <section className="section studio" id="studio">
        ...
        <div className="section-content">
          <div className="studio-heading">
            ...
            <p>I started a TikTok Shop to give my DIY creations a home beyond my desk. I make the products, set up the shop, create promotional TikToks, and experiment with how to introduce an idea to an audience. It is a personal project, but I treat every post and product as a chance to observe, learn, and make a more thoughtful next version.</p>
          </div>
      ...
      <section className="section skills" id="skills">
        ...
        <div className="section-content skills-layout">
          <div><h2>Technical thinking, with room for a little imagination.</h2><div className="skill-cloud" aria-label="Technical skills">{skills.map((skill) => <span key={skill}>{skill}</span>)}</div><aside className="ai-note"><span aria-hidden="true">✦</span><p><strong>AI helps me build faster.</strong> I bring the curiosity to decide what is worth building, the judgement to check the work, and the care to make it useful for people.</p></aside></div>
